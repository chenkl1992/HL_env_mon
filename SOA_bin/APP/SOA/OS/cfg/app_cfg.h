...
#define  APP_CFG_TCP_TASK_PRIO		                         4u
#define  APP_CFG_UDP_TASK_PRIO		                         11u
...
#define  APP_CFG_UPDATE_TASK_PRIO		                 3u
...
#define  APP_CFG_NET_TASK_STK_SIZE           		        256u
#define  APP_CFG_REGISTER_TASK_STK_SIZE           		256u
#define  APP_CFG_HEARTBEAT_TASK_STK_SIZE           		256u
#define  APP_CFG_TCP_TASK_STK_SIZE           		        256u
#define  APP_CFG_UDP_TASK_STK_SIZE           		        256u
#define APP_CFG_SUPERVISION_TASK_STK_SIZE                       128u

#define  OS_STK_SIZE_SERVICE_SHELL                              256u
#define  APP_CFG_DATA_TASK_STK_SIZE           		        512u
